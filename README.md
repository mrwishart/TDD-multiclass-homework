# More MultiClass and TDD homework

Week 2, Day 2 Homework at CodeClan. Reinforcing use of multiple classes along with TDD.
...
- A bear should be able to take a fish from the river **and eat it**
